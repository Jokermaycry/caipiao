...
public class NiceSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int defaultPadding = resources.getDimensionPixelSize(R.dimen.one_two);

        setGravity(Gravity.CENTER_VERTICAL | Gravity.START);
        setPadding(resources.getDimensionPixelSize(R.dimen.two_four), defaultPadding, defaultPadding,
                defaultPadding);
        setClickable(true);
    ...
    private void measurePopUpDimension() {
        ...
        int heightSpec = MeasureSpec.makeMeasureSpec(getMeasuredHeight()+200, MeasureSpec.EXACTLY);
