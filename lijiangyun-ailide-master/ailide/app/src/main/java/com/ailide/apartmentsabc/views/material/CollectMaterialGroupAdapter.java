...
public class CollectMaterialGroupAdapter extends BaseQuickAdapter<CollectMaterialGroup, BaseViewHolder> {

    public CollectMaterialGroupAdapter(@Nullable List<CollectMaterialGroup> data) {
    ...
    protected void convert(final BaseViewHolder helper, final CollectMaterialGroup item) {
        ...
        adapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                EventBus.getDefault().post(new EventBusEntity(EventConstant.TO_COLLECT_MATERIAL_DETAIL, item));
            }
        });
    }
}