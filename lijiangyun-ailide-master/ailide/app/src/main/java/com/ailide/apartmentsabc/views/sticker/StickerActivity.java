...
//        mToolsFragment.add(graffitiToolFragment);
 ...
 /*       stickerView.setBackgroundColor(Color.WHITE);
        ...
        mExSticker.setOnTouchListener(new View.OnTouchListener() {
            @Override
    ...
    @OnClick({R.id.iv_back, R.id.ll_move_up, R.id.ll_move_down, R.id.ll_draft, R.id.ll_save, R.id.ll_print,
...
//                finish();
            ...
            case R.id.ll_move_down:
                ...
                break;
            case R.id.ll_draft:
                jumpToOtherActivity(new Intent(this, ScrapPaperActivity.class), false);
                break;
            case R.id.ll_save:
//                save();
                saveToDraftNoFinish();
    ...
    public void saveToDraft() {
        new AsyncTask<String, String, String>() {
          ...
          /*      for (DrawPath path :
                ...
                File file = FileUtil.getStickerDraftFile(draft.getTime());
    ...
    private void showPopView() {
        ...
        pop_equitment_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                popupWindow.dismiss();
                jumpToOtherActivity(new Intent(StickerActivity.this, MyEquitmentActivity.class), false);
            }
        });
...
//                mExSticker.addSticker(new DrawableSticker((String) event.getData(), mExSticker.getFlSticker().getWidth() - mExSticker.getStickerViewMargin() * getResources().getDisplayMetrics().density));
//                mExSticker.addSticker(new DrawableSticker((String) event.getData(), getResources().getDisplayMetrics().widthPixels - 70 * getResources().getDisplayMetrics().density));
            ...
            case EventConstant.MY_MATERIAL:
                mExSticker.addSticker(new DrawableSticker(new BitmapDrawable((Bitmap) event.getData()), mExSticker.getStickerView().getWidth()));
//                mExSticker.addSticker(new DrawableSticker(new BitmapDrawable((Bitmap) event.getData()), mExSticker.getFlSticker().getWidth()));
            ...
            case EventConstant.PICTURE_LIST:
                mExSticker.addSticker(new DrawableSticker((String) event.getData(), mExSticker.getStickerView().getWidth()));
//                mExSticker.addSticker(new DrawableSticker((String) event.getData(), mExSticker.getFlSticker().getWidth() - mExSticker.getStickerViewMargin() * getResources().getDisplayMetrics().density));
//                mExSticker.addSticker(new DrawableSticker((String) event.getData(), mExSticker.getWidth()-(params.leftMargin+params.rightMargin)*getResources().getDisplayMetrics().density));
//                mExSticker.addSticker(new DrawableSticker((String) event.getData(), getResources().getDisplayMetrics().widthPixels - 70 * getResources().getDisplayMetrics().density));
                hideVpTool();
                break;
    ...
    public void AddEmojiDrawable(String name) {
        if (mVpTool.getVisibility() == View.VISIBLE) {
            if (!TextUtils.isEmpty(name)) {
                mExSticker.addSticker(new DrawableSticker(PATH_STICKER_EMOJI + "/" + name, getResources().getDisplayMetrics().widthPixels / 2.0f));
            }
            hideVpTool();
        } else {
            finish();
...
//                .setPadding(30, 30, 30, 30)
    ...
    public void showDraft(final StickerDraft draft) {
        ...
        if (draft.getTheme() != null) {
            changeTheme(draft.getTheme());
            themeToolFragment.setSelect(draft.getTheme());
        }
