...
public class LabelPrePrintActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_label_preprint);
        ButterKnife.bind(this);
        initView();
    }

    public void initView() {
        mIvPic.setBackground(getResources().getDrawable(R.drawable.bg_label));
        mIvPic.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            @Override
            public void onGlobalLayout() {
                mIvPic.getViewTreeObserver().removeOnGlobalLayoutListener(this);
                width = mIvPic.getWidth();
                mScaleMargin =width / 384 * 8;
                LinearLayout.LayoutParams params = (LinearLayout.LayoutParams) mIvPic.getLayoutParams();
                params.height = mScaleMargin * getIntent().getIntExtra("size", 15);
                params.width = mScaleMargin * 53;
                mIvPic.setLayoutParams(params);
                mIvPic.setPadding((int) (0.5 * mScaleMargin), (int) (0.5 * mScaleMargin), (int) (0.5 * mScaleMargin), (int) (0.5 * mScaleMargin));

                Glide.with(LabelPrePrintActivity.this)
                            ...
                            public void onResourceReady(Bitmap bitmap, GlideAnimation glideAnimation) {
                                ...
                                new AsyncTask<Integer, Integer, Bitmap>() {
                                    ...
                                    protected Bitmap doInBackground(Integer... integers) {
                                        ...
                                        printBitmap = convertGreyImgByFloyd(luminosity);
                                        return convertGreyImgByFloyd(bitmap2Gray(bitmap1));
                                    }
