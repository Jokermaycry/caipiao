...
public class SearchMaterialGroupAdapter extends BaseQuickAdapter<MaterialGroup, BaseViewHolder> {

    public SearchMaterialGroupAdapter(@Nullable List<MaterialGroup> data) {
        super(R.layout.item_search_material_group, data);
    }
